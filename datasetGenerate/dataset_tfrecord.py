...
directory='/Users/lulei05/Documents/study/deep_learning/common_data/第4章 配套资源/4-11  将TFRecord文件制作成Dataset数据集/'

def dataset(directory, size, batchsize):  # 定义函数，创建数据集
    """ parse  dataset."""

    def _parseone(example_proto):  # 解析一个图片文件t
...
sample_dir = [directory + 'mydata.tfrecords']
size = [256, 256, 3]
batchsize = 10
